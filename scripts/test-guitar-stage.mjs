...
const SCREENS = [
  ...
  /*
   * 横向きで幅が 900px を超える端末（例: 915x412）。
   *
   * 「画面いっぱいに広げる」一式を幅だけで当てていたので、ここでは
   * 当たらず、弦の揺れる絵の面が残って指板の上に 115px の空きが
   * できていた。780px しか見ていなかったので検査は素通りした。
   */
  { w: 915, h: 412, label: '横 915', bare: true },
];
